...
$conn = mysqli_connect("localhost","root","root","Pressing");
	$result = mysqli_query($conn,"SELECT DISTINCT COMMANDE.ID_COMMANDE , COMMANDE.ID_CLIENT , COMMANDE.DD_COMMANDE ,COMMANDE.STATUS, COMMANDE.DF_COMMANDE , SUM(PANIER.QUANITE) as QUANTITE , SUM(PANIER.MONTANT)as MONTANT , LOCALISATION.Adresse_Complete_Collect 
