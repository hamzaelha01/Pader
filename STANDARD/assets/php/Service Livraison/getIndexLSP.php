...
$query ="SELECT COMMANDE.ID_COMMANDE , CLIENT.NOM_CLIENT , CLIENT.PRENOM_CLIENT , COMMANDE.DD_COMMANDE , LOCALISATION.Adresse_Complete_Collect , COMMANDE.NBR_ARTICLES , COMMANDE.LIVREUR_COLLECTE FROM COMMANDE , CLIENT , LOCALISATION  WHERE COMMANDE.ID_CLIENT = CLIENT.ID_CLIENT AND COMMANDE.ID_LOCALISATION = LOCALISATION.ID_LOCALISATION AND COMMANDE.STATUS  LIKE 'CONFIRMED'";
