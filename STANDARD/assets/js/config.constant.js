...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        'vAccordionCtrl': 'assets/js/controllers/API/vAccordionCtrl.js',
        'ckeditorCtrl': 'assets/js/controllers/ckeditorCtrl.js',
        'laddaCtrl': 'assets/js/controllers/laddaCtrl.js',
        'ngTableCtrl': 'assets/js/controllers/API/ngTableCtrl.js',
        ...
        'calendarCtrl': 'assets/js/controllers/API/calendarCtrl.js',
        ...
        'inboxCtrl': 'assets/js/controllers/API/inboxCtrl.js',
        'xeditableCtrl': 'assets/js/controllers/xeditableCtrl.js',
        'chatCtrl': 'assets/js/controllers/API/chatCtrl.js',
        'dynamicTableCtrl': 'assets/js/controllers/API/dynamicTableCtrl.js',
